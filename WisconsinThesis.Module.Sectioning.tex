...
\newcommand{\LevelToSection}[1]{% #1 = Level number
    \IfNumber{#1}%
        {\SetCounter{WorkCounter}{#1}%
         \AddToCounter{WorkCounter}{2}%
         \ArrayGet{LevelToSection}{WorkCounter}}%
        {\IfCommandExists{#1}%
            {\SetCounter{WorkCounter}{\CounterValue{#1}}%
             \AddToCounter{WorkCounter}{2}%
             \ArrayGet{LevelToSection}{WorkCounter}}%
            {}}%
}
