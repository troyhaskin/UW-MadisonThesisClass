...
\begin{Nomenclature}
    ...
    \begin{SubNomenclature}{Acronyms (A SubNomenclature)}
    ...
    \Add{\Omega}{   A post-SubNomenclature entry.
                    ...
                    This isn't a particularly useful feature and should be avoided for clarity and is only supported in case an entry is accidentally added after a SubNomenclature.}
    \Add{Symbol} {Post-SubNomenclature \Cmd{WidestSymbol} test.}
\end{Nomenclature}
